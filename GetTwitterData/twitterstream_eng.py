...
def fetchsamples():
    ...
    #url = "https://stream.twitter.com/1/statuses/filter.json?locations=99,12,102,17"
    #url = "https://stream.twitter.com/1/statuses/filter.json?locations=-180,-90,180,90&language=th"
    #url = "https://stream.twitter.com/1/statuses/filter.json?delimited=length&language=en"
    #url = "https://stream.twitter.com/1/statuses/filter.json?language=th"
    parameters = []
